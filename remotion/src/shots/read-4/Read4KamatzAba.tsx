...
import beats from '../../../../reading-shorts/read-4-kamatz-aba/beats.json';
...
export const compositionConfig = {
  id: 'Read4KamatzAba',
  durationInSeconds: 56.464,
  fps: 30,
  width: 1080,
  height: 1920,
};
const Read4KamatzAba: React.FC = () => <ReadingShort beats={beats} vo={VO} />;
export default Read4KamatzAba;
