      ...
      <CollageBoard cam={CAM}>
        ...
        <Sequence from={0} durationInFrames={160} layout="none">
          <SceneFade out={157}>
            ...
            <Cutout src={asset('cup.png')} x={540} y={1120} w={600} at={CUE.hookCup} enter="place" rotate={2.5} depth={0.08} shadow={3} style="torn" />
        ...
        <Sequence from={140} durationInFrames={880} layout="none">
          <SceneFade out={876} dur={22}>
            ...
            <Cutout src={asset('branch.png')} x={165} y={430} w={380} at={25} enter="slide-l" rotate={-6} depth={0.12} sticker={6} shadow={2} style="torn" />
          </SceneFade>
        </Sequence>
        ...
        <Sequence from={CUE.banStart} durationInFrames={215} layout="none">
          <SceneFade out={211}>
            <Cutout src={asset('sultan.png')} x={830} y={880} w={470} at={CUE.sultanIn - CUE.banStart} enter="slide-r" rotate={2} depth={0.08} sticker={6} shadow={3} style="torn" />
        ...
        <Sequence from={CUE.todayStart} layout="none">
          <Cutout src={asset('cup.png')} x={540} y={1120} w={600} at={CUE.cupBack - CUE.todayStart} enter="place" rotate={2.5} depth={0.08} shadow={3} style="torn" />
